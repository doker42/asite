    ...
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" href="{{route('admin_user_list')}}">
                        <svg class="bi"><use xlink:href="#people"/></svg>
                        {{__('Users')}}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" href="{{route('admin_about_list')}}">
                        <svg class="bi"><use xlink:href="#about"/></svg>
                        {{__('AboutSection')}}
                    </a>
                </li>
                <li class="nav-item">
